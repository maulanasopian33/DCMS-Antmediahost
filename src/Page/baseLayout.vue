<template>
      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
               <button @click="slidebarAction()" id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" class="lg:hidden mr-2 text-gray-600 hover:text-gray-900 cursor-pointer p-2 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 rounded">
               ...
               <span class="self-center whitespace-nowrap">DCVMS</span>
               </a>
   ...
   <div class="flex overflow-hidden bg-white pt-16">
      <aside id="sidebar" :class="slidebar ? 'flex':'hidden'" class="fixed z-20 h-full top-0 left-0 pt-16 lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
            ...
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div class="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                        <router-link to="/" class="text-base text-white font-norma bg-orange-600 rounded-lg flex items-center p-2 hover:text-gray-900 hover:bg-gray-100 group">
                     ...
                     <li>
                        <router-link to="/visitdc" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                     ...
                     <li>
                        <a href="#" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <span class="ml-3 flex-1 whitespace-nowrap">Setting</span>
                        </a>
                     </li>
                  </ul>
               </div>
      ...
      <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
        <slot></slot>
         ...
         <p class="text-center text-sm text-gray-500 my-10">
            &copy; 2023 <a href="#" class="hover:underline" target="_blank">Antmediahost</a>. All rights reserved.
         </p>
      </div>
   </div>
...
export default {
    ...
    methods: {
        getuser() {
            axios.get(this.url + 'getUser/' + this.userId).then(({
                data
            }) => {
