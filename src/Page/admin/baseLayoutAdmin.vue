               ...
               <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                  <div class="flex-1 px-3 bg-white divide-y space-y-1">
                     <ul class="space-y-2 pb-2">
                        ...
                        <li>
                           <router-link
                              :class="$route.path === '/admin' ? 'bg-orange-600 text-white ' : 'text-gray-900 hover:text-gray-900 hover:bg-gray-100 group'"
                              to="/admin" class="text-base  font-normal  rounded-lg flex items-center p-2 ">
                              <i class="fa fa-chart-pie"></i>
                              <span class="ml-3">{{ lang.menu_dashboard }}</span>
                           </router-link>
                        </li>
                        <li>
                           <router-link to="/admin/visitdc"
                              :class="$route.path === '/admin/visitdc' || $route.path === '/visitdc/add' ? 'bg-orange-600 text-white ' : 'text-gray-900 hover:text-gray-900 hover:bg-gray-100 group'"
                        ...
                        <li>
                           <router-link to="/admin/surat"
                              :class="($route.path).includes('/admin/surat') ? 'bg-orange-600 text-white ' : 'text-gray-900 hover:text-gray-900 hover:bg-gray-100 group'"
                              class="text-base font-normal rounded-lg  flex items-center p-2 ">
                        ...
                        <li>
                           <router-link to="/admin/usermanage"
                              :class="$route.path === '/admin/usermanage' ? 'bg-orange-600 text-white ' : 'text-gray-900 hover:text-gray-900 hover:bg-gray-100 group'"
                              class="text-base font-normal rounded-lg  flex items-center p-2 ">
                        ...
                        <li>
                           <router-link to="/admin/vpn"
                              :class="$route.path === '/admin/vpn' ? 'bg-orange-600 text-white ' : 'text-gray-900 hover:text-gray-900 hover:bg-gray-100 group'"
                              class="text-base font-normal rounded-lg  flex items-center p-2 ">
                              <i class="fa fa-globe"></i>
                              <span class="ml-3 flex-1 whitespace-nowrap">Manage VPN</span>
                           </router-link>
                        </li>
                     </ul>
                  </div>
