                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex-shrink-0">
                                        <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{
                                            lang.visitdc_chartTitle }}</span>
                                        <h3 class="text-base font-normal text-gray-500">{{ lang.visitdc_chartSubtitle }}
                                        </h3>
                                    </div>
                                </div>
                                <div id="main-chart">
                                    <apexchart height="300" ref="chart" :options="chartOptions" :series="chartSeries">
                                    </apexchart>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                        <div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6">
                            <div class="mb-4 flex items-center justify-between">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">{{ lang.visitdc_summaryTitle }}
                                    </h3>
                                    <span class="text-base font-normal text-gray-500">{{ lang.visitdc_summarySubtitle
                                        }}</span>
                                </div>
                            </div>
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200">
                                                ...
                                                <tbody class="bg-white" v-for="(item, index) in visitdc" :key="index">
                                                    <tr>
                                                        ...
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">
                                                            <span @click="viewdetail(item.UID, item.id_user)"
                                                                class="bg-green-500 p-2 text-white rounded-tl-md rounded-bl-md cursor-pointer"><i
...
import { getKey } from '../../utils/RSAClass';
export default {
    name: 'dashboardAdmin',
