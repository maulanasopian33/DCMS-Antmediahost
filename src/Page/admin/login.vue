<template>
    <div>
        ...
        <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
            <div class="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">Login To Admin Panel</div>
            ...
            <div class="mt-10">
                ...
                <div class="relative">
                    ...
                    <input id="username" type="text" name="username" v-model="username" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="E-Mail Address" />
                </div>
                <label for="username" class="mb-1 text-xs tracking-wide text-red-600">{{ error.username }}</label>
                </div>
                <div class="flex flex-col mb-6">
                ...
                <div class="relative">
                    ...
                    <input id="password" type="password" v-model="password" name="password" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" />
                </div>
                <label for="password" class="mb-1 text-xs tracking-wide text-red-600">{{ error.password }}</label>
                </div>
                ...
                <button @click="login()" class="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
